...
#ifndef _MQWeb_ListenerStatusController_h
#define _MQWeb_ListenerStatusController_h
...
class ListenerStatusController : public MQController
...
public:
	...
	virtual ~ListenerStatusController();
		/// Destructor
...
inline const Controller::ActionMap& ListenerStatusController::getActions() const
{
	static Controller::ActionMap actions 
		= MapInitializer<std::string, Controller::ActionFn>
			("index", static_cast<ActionFn>(&ListenerStatusController::index))
			("inquire", static_cast<ActionFn>(&ListenerStatusController::inquire));
	return actions;
}

inline std::string ListenerStatusController::getDefaultAction() const
{
	return "index";
}
...
#endif // _MQWeb_ListenerStatusController_h
