 ...
 */
#ifndef _MQWeb_TopicMapper_H
#define _MQWeb_TopicMapper_H
...
class TopicMapper : public MQMapper
	/// Maps process object to/from Websphere MQ
{
public:

	TopicMapper(CommandServer& commandServer, Poco::JSON::Object::Ptr input);
		/// Constructor
...
private:
	...
	TopicMapper(const TopicMapper&);

};

}} // Namespace MQ::Web

#endif // _MQWeb_TopicMapper_H
