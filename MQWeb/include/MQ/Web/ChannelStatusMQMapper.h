 ...
 */
#ifndef _MQWeb_ChannelStatusMQMapper_H
#define _MQWeb_ChannelStatusMQMapper_H
...
public:
  ...
  ChannelStatusMQMapper(CommandServer& commandServer);


  virtual ~ChannelStatusMQMapper();
...
private:
  ...
  ChannelStatusMQMapper(const ChannelStatusMQMapper&);
};


}} // Namespace MQ::Web

#endif // _MQWeb_ChannelStatusMQMapper_H
