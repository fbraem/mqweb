				...
				<div id="main">
					...
					<div class="widgets">
						<div class="result" id="result">
							<? if queues ?>
								<table style="border-spacing:0;border-collapse:collapse;width:100%" id="queueTable">
									<tr>
									 <th></th><th>Type</th><th>Depth</th><th>In</th><th>Out</th><th>Get</th><th>Put</th><th>Usage</th>
									</tr>
									<? for queue queues	?>
										<tr	class="detail">
										 <td><a	href="/queue/view/<?=	mqweb.qmgr	?>/<?= queue.QName.value ?>"><?= queue.QName.value ?></a>
											<? if	queue.BaseQName	?>
											 <br />
											 <span style="padding:5px;font-size:0.85em"><strong>Target:</strong> <a	href="/queue/view/<?= mqweb.qmgr ?>/<?= queue.BaseQName.value ?>"><?= queue.BaseQName.value ?></a></span>
											<? endif ?>
											<? if	queue.RemoteQName	?>
											 <br />
											 <span style="padding:5px;font-size:0.85em"><strong>Qmgr:</strong> <?= queue.RemoteQmgrName.value	?> Queue:	<?=	queue.RemoteQName.value	?></span><br />
											 <span style="padding:5px;font-size:0.85em"><strong>Transmission	Queue:</strong> <a	href="/queue/view/<?= mqweb.qmgr ?>/<?= queue.XmitQName.value ?>"><?= queue.XmitQName.value ?></a></span>
											<? endif ?>
											<? if	queue.QDesc.value	?>
												<br	/><em	style="padding:5px;font-size:0.85em"><?=	queue.QDesc.value	?></em>			 
											<? endif ?>
										 </td>
