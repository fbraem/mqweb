	...
	<div style="margin:10px;" data-bind="if: queuesModel.queues">
		<table id="queueTable" style="width:100%;border-collapse:collapse">
			...
			<tbody data-bind="foreach: { data: queuesModel.queues, as: 'queue'}">
				<tr>
					<td>
						<a data-bind="attr: { href: '/queue/view/<?= mqweb.qmgr ?>/' + queue.QName.value}, text: queue.QName.value"></a>
					...
					<td style="text-align:center">
						<div data-bind="if: queue.InhibitGet">
							<img data-bind="if: queue.InhibitGet.value" src="/static/images/enabled.gif" />
							<img data-bind="ifnot: queue.InhibitGet.value" src="/static/images/disabled.gif" />
						</div>
					...
					<td style="text-align:center">
						<div data-bind="if: queue.InhibitPut">
							<img data-bind="visible: queue.InhibitPut.value" src="/static/images/enabled.gif" />
							<img data-bind="visible: !queue.InhibitPut.value" src="/static/images/disabled.gif" />
						</div>
					...
					<td>
						<span data-bind="if: queue.Usage, text:queue.Usage.display" />
					</td>
				</tr>
			</tbody>
		</table>
