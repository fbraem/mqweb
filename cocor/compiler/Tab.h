...
typedef Poco::HashMap<std::string, Symbol*> SymbolHashMap;
...
public:
  ...
  SymbolHashMap literals;        // symbols that are used as literals
  ...
  Symbol* NewSym(int typ, const std::string& name, int line);
  Symbol* FindSym(const std::string& name);
	...
	void Finish(Graph *g);
	void DeleteNodes();
  Graph* StrToGraph(const std::string& str);
  ...
  CharClass* NewCharClass(const std::string& name, CharSet *s);
  CharClass* FindCharClass(const std::string& name);
	CharClass* FindCharClass(CharSet *s);
	CharSet* CharClassSet(int i);

	//----------- character class printing

  std::string Ch(const char ch);
  ...
  void ResErr(Node *p, const std::string& msg);
	...
	void XRef();
  void SetDDT(const std::string& s);
